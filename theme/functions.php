...
// CONDICIONAL ESTÁ MAL COMPÁ!!!!!!!!!!!!!!!!!!
//         // $human_user=get_user_meta($current_user->ID, 'wp_human_user');
//         if (preg_match('/lifeband/',$email_user)) {
//             wp_redirect('http://' . $_SERVER['HTTP_HOST'] . '/confirmar-datos/?hash=540f6f564efghahk');
//             exit;
//         } else {
//             wp_redirect('http://' . $_SERVER['HTTP_HOST'] . '/datos-medicos/');
//             exit;
...
/*add_filter( 'login_redirect', 'redirect_user_on_role' );*/
 // add_filter( 'admin_init', 'redirect_user_on_role' );
//add_action('template_redirect', 'redirect_user_on_role');
// function cm_redirect_users_by_role() {
//     $current_user   = wp_get_current_user();
//     $role_name      = $current_user->roles[0];
//     if ( 'administrator' === $role_name ) {
//         wp_redirect( 'http://lifeband.com.mx/datos-basicos' );
//     } // if
...
{
    return wp_redirect('http://' . $_SERVER['HTTP_HOST'] . '/confirmar-datos/?hash=540f6f564efghahk'); 
    // exit();
    // return home_url();
}*/
