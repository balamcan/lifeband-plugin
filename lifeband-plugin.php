...
function lifeband_plugin_install(){
    ...
    $wpdb->query("DROP TABLE IF EXISTS `wp_cat_tipo_diabetes`;
            CREATE TABLE IF NOT EXISTS `wp_cat_tipo_diabetes` (
           `id` int(11) NOT NULL AUTO_INCREMENT,
           `nombre` varchar(20) NOT NULL,
           PRIMARY KEY (`id`)
                ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ;
                INSERT INTO `wp_cat_tipo_diabetes` (`id`, `nombre`) VALUES
           (1, 'Ninguna'),
           (2, 'Tipo 1'),
           (3, 'Tipo 3'),
           (4, 'Gestacional');");
    $wpdb->query("DROP TABLE IF EXISTS `wp_cat_tipo_sangre`;
            CREATE TABLE IF NOT EXISTS `wp_cat_tipo_sangre` (
            `id` int(11) NOT NULL AUTO_INCREMENT,
            `nombre` varchar(3) NOT NULL,
            PRIMARY KEY (`id`)
          ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ;
          INSERT INTO `wp_cat_tipo_sangre` (`id`, `nombre`) VALUES
          (1, 'O-'),
          (2, 'O+'),
          (3, 'A-'),
          (4, 'A+'),
          ...
          (8, 'AB+');");
    //the others tables
            $wpdb->query("CREATE TABLE IF NOT EXISTS `wp_datos_medicos` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          ...
          KEY `fk_wp_datos_medicos_wp_cat_tipo_diab_idx` (`wp_cat_tipo_diabetes_id`)
            ...
            $wpdb->query("CREATE TABLE IF NOT EXISTS `wp_datos_basicos` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          `wp_users_id` int(11) NOT NULL,
